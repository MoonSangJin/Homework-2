...
class CString{
	...
	public :
		...
		strcpy(pStr,str); cout<<"CString 持失切"<<endl;}
		virtual ~CString(){delete []pStr; cout<<"CSring 社瑚切"<<endl;}	
};
...
class CMyString : public CString{
	...
	public :
		CMyString(char *str1, char *str2) : CString(str1){
			...
			strcpy(pMyStr, str2); cout<<"CMyString 持失切"<<endl;}
			~CMyString(){delete [] pMyStr; cout<<"CMyString 社瑚切"<<endl;}	
};
